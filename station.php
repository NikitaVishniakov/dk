<div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div id="core_modal_body" class="modal-body"><form id="pto_form" class="ajax_form" data-url="/to/user/ajax/experttable/FA1111/1" method="POST">
                            ...
                            <tr>
                                ...
                                <td class="col-md-6 text-center">
                                    <b>Список для пользователя</b>
                                                                        <span style="top: 3px;" class="glyphicon glyphicon-question-sign pop" data-container="body" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Список станций, доступных Вам. С его помощью вы можете добавлять или удалять станции у всех своих подчиненных." data-html="false"></span>                                </td>
                            </tr>
                        </thead>
                        <tbody>
                                                                                                                                                                                                                                                                            <tr>
    ...
    <div class="row" style="margin-bottom: 5px;">
        ...
        <div class="col-md-7">
            <select id="pto_form_experts" name="pto_form[experts]" class="form-control" autocomplete="off" data-placeholder="Выберите ПТО..." style="display: none;">            <option value="1">СТО</option></select><div class="chosen-container chosen-container-single" style="width: 100%;" title="" id="pto_form_experts_chosen"><a class="chosen-single" tabindex="-1"><span>СТО</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off"></div><ul class="chosen-results"><li class="active-result result-selected" data-option-array-index="0">СТО</li></ul></div></div>
    ...
    <div class="row" style="margin-bottom: 5px;">
        <div class="col-md-8 text-center">
            <input id="expert_block_submit" type="submit" class="btn btn-success" value="Применить настройки станции">
        </div>
        <div class="col-md-4 text-center">
            <button class="btn expert_form_btn reset_form" data-url="/to/user/ajax/experttable">
                Отмена
            </button>
        </div>
    </div>
            <input type="hidden" id="pto_form_experts_json" name="pto_form[experts_json]" required="required" value="[{&quot;id&quot;:1}]"><input type="hidden" id="pto_form__token" name="pto_form[_token]" value="wQqaSamMQyeIqr5Cyidb5KTwzfWCEumcibCgYI-uJkw">
    </form>
    <script>
        $("#pto_form_expertAddressPointPrefix")
                .chosen({
            ...
            $("#pto_form_experts")
                    .chosen({
                        no_results_text: "эксперт не найден!",
                        allow_single_deselect: true,
                        width: "100%"
                    })
                    .val("1").trigger("chosen:updated")
                    ;
            $("#expert_block_submit").on("click", function (e) {
                e.preventDefault();
                $("#pto_form").submit();
            });
    </script></div>
